...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
#define TRIG1_PIN GPIO_PIN_9   // PA9
#define TRIG1_PORT GPIOA
#define ECHO1_PIN GPIO_PIN_8   // PA8
#define ECHO1_PORT GPIOA

#define TRIG2_PIN GPIO_PIN_10  // PA10
#define TRIG2_PORT GPIOA
#define ECHO2_PIN GPIO_PIN_11  // PA11
#define ECHO2_PORT GPIOA

#define TRIG3_PIN GPIO_PIN_12  // PA12
#define TRIG3_PORT GPIOA
#define ECHO3_PIN GPIO_PIN_15   // PB5
#define ECHO3_PORT GPIOA

#define TRIG4_PIN GPIO_PIN_0   // PB0
#define TRIG4_PORT GPIOB
#define ECHO4_PIN GPIO_PIN_1   // PB1
